...
def get_true_env(args, read_user_num=None):
    ...
    elif args.env == "NowPlaying-v0":
        from src.core.envs.NowPlaying.NowPlayingEnv import NowPlayingEnv
        from src.core.envs.NowPlaying.NowPlayingData import NowPlayingData
        mat, list_feat, mat_distance = NowPlayingEnv.load_env_data()
