...
class EntropySimulatedEnv(gym.Env):
    def __init__(self, ensemble_models,
                 env_task_class, lambda_entropy, 
                 task_env_param: dict, task_name: str,
                 predicted_mat=None, 
                 ):
        ...
        self.category_distribution = self.env_task.category_distribution
    ...
    def step(self, action: FloatTensor):
        ...
        real_state, real_reward, _, c_distribution, real_terminated, real_truncated, real_info = self.env_task.step(action)
        ...
        pred_reward = pred_reward + self.lambda_entropy * entropy
        ...
        return self.state, pred_reward, 0, c_distribution, terminated, truncated, info
