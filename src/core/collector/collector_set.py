...
class CollectorSet(object):
    def __init__(self, policy, envs_dict, buffer_size, env_num,
                 ...
                 force_length=10, is_hrl=False, info=''):
        self.collector_dict = {}
    ...
    def collect(
        ...
        all_res = {}
        for name, collector in self.collector_dict.items():
            res, res_plt = collector.collect(n_step, n_episode, random, render, no_grad, is_train=False, current_epoch=current_epoch)
