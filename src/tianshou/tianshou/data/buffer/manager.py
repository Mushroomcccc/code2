...
from tianshou.data.buffer.hrlbuf import HReplayBuffer
...
class ReplayBufferManager(ReplayBuffer):
    ...
    def __init__(
        self, buffer_list: Union[List[ReplayBuffer], List[HERReplayBuffer], List[HReplayBuffer]]
    ) -> None:
...
class HReplayBufferManager(HReplayBuffer):
    """ReplayBufferManager contains a list of ReplayBuffer with exactly the same \
    configuration.
